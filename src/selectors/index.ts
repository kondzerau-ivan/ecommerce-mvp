export const loginButton = document.querySelector('.js-login') as HTMLButtonElement;
export const logoutButton = document.querySelector('.js-logout') as HTMLButtonElement;
